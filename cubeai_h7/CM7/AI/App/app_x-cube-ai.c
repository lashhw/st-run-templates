...
STAI_ALIGNED(32) 
AI_RAM_D1 
static uint8_t RAM_D1[STAI_NETWORK_ACTIVATION_1_SIZE_BYTES];


/* Global c-array to handle the activations buffer */
stai_ptr data_activations[] = { RAM_D1 };
...
#include "my_model_name.h"
  LC_PRINT(" %s duration DWT    : %d.%03d ms\r\n", my_model_name, t.s * 1000 + t.ms, t.us);
