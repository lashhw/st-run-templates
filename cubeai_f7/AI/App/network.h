...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "shuffleim100vm96tinyts_w0_5_ir96_split_quantized"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x5fd20703d5f909978c4a11f12528c751"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0xdbee9837732b6950)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,3,96,96}
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,100}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (100)
#define STAI_NETWORK_OUT_1_RANK        (1)
#define STAI_NETWORK_OUT_1_SIZE        ((100))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (100)
#define STAI_NETWORK_OUT_1_SCALE       (1.3354321708902717e-05f)
#define STAI_NETWORK_OUT_1_ZERO_POINT  (14)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (76848)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (76848)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (76848)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (76848)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (53232)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (53232)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (53232)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (53232)
